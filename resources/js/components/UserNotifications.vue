<template>
	<li class="nav-item dropdown" v-if="notifications.length">
		...
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" width="1rem" style="enable-background:new 0 0 512 512;" xml:space="preserve">
			<g>
				<g>
